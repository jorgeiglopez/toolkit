...
- Update mode:
  > Using the `lpz-pre-flight` skill to update the existing pre-flight script(s).
- Fresh mode:
  > Using the `lpz-pre-flight` skill to generate a fresh pre-flight script for this repo.
