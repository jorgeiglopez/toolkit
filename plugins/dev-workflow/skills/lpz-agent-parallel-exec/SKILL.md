...
`lpz-agent-dispatch` skill; worktree mechanics follow `lpz-git-worktree`. Bake-off
specifics on top:
...
Run `lpz-git-worktree`'s cleanup sweep over EVERY candidate, winner
