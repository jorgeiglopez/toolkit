...
description: "Run git-history diagnostics on a repo to surface churn hotspots, bus factor, bug-fix clusters, velocity trends, and crisis patterns. Use when asked to diagnose a codebase, audit a repo, find what's risky in this codebase, run a codebase health check, or check bus factor, churn hotspots, or where bugs cluster."
---
