...
live in `<project>/.claude/agent-dispatch/dispatch-constraints.md`. The
dispatch prompt says:

> Read and obey `<project>/.claude/agent-dispatch/dispatch-constraints.md` before starting.
...
`<project>/.claude/agent-dispatch/ledger/` (one file per orchestration,
