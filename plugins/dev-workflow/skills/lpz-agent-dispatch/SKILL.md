...
live in `<project>/.claude/lpz-agent-dispatch/dispatch-constraints.md`. The
dispatch prompt says:

> Read and obey `<project>/.claude/lpz-agent-dispatch/dispatch-constraints.md` before starting.
...
`<project>/.claude/lpz-agent-dispatch/ledger/` (one file per orchestration,
