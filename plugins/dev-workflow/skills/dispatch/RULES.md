...
- Orchestrations longer than one sitting keep a progress ledger under `<project>/.claude/dispatch-skill/ledger/` (task, status, commit range) and re-read it after compaction; conversation memory is not durable state.
