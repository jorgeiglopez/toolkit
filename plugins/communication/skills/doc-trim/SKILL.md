---
name: doc-trim
description: "Trim editorial bloat from an existing document (ADR, README, investigation writeup, KB note) using six named cut-reasons; output an approval-gated diff. Use when asked to trim this doc, tighten this writeup, prune the doc, run a filter pass on X.md, or cut the slop from an existing document."
---
