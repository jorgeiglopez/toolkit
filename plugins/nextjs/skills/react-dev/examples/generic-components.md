...
Generic components provide type safety while maintaining reusability. TypeScript infers generic type parameters from prop values, so no manual type annotations are needed at the call site.
