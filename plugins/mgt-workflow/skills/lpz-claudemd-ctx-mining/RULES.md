...
- Present candidates with a code example and ask before applying; don't edit CLAUDE.md or skills unprompted.
- Route global conventions to CLAUDE.md, skill-specific patterns into the relevant skill instead.
